<div>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div x-data="{ open: false }" @click.outside="open = false">
            ...
            @if($type === 'sale')
                <input type="text" wire:model.live="customerSearch" wire:input="searchCustomers" @focus="open = true"
                ...
                @endif
            @else
                <input type="text" wire:model.live="supplierSearch" wire:input="searchSuppliers" @focus="open = true"
