...
<aside class="fixed inset-y-0 right-0 z-50 w-64 bg-gray-900 text-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 translate-x-full lg:translate-x-0" dir="rtl">
    <!-- Logo -->
    <div class="flex items-center h-16 border-b border-gray-800 px-3">
    ...
    <nav class="mt-4 px-3 space-y-1 overflow-y-auto" style="max-height: calc(100vh - 180px)">
        ...
        <!-- المبيعات -->
        <div x-data="{ open: {{ in_array(true, [request()->routeIs('sales-invoices.*'), request()->routeIs('sales-returns.*'), request()->routeIs('discount-notes.*'), request()->routeIs('quotations.*'), request()->routeIs('customers.*')]) ? 'true' : 'false' }} }">
            <button @click="open = !open" class="flex w-full items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition text-gray-300 hover:bg-gray-800 hover:text-white">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-collapse class="mr-8 mt-1 space-y-1">
                ...
                <a href="{{ route('discount-notes.index') }}" class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition {{ request()->routeIs('discount-notes.*') ? 'bg-blue-600/20 text-blue-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <span class="h-1.5 w-1.5 rounded-full bg-current"></span>
                    إشعارات الخصم
                </a>
        ...
        <!-- أرشيف المستندات -->
        <div x-data="{ open: {{ request()->routeIs('document-archives.*') ? 'true' : 'false' }} }">
            <button @click="open = !open" class="flex w-full items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('document-archives.*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-collapse class="mr-8 mt-1 space-y-1">
                <a href="{{ route('document-archives.index') }}" class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition {{ request()->routeIs('document-archives.index') || request()->routeIs('document-archives.show') ? 'bg-blue-600/20 text-blue-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <span class="h-1.5 w-1.5 rounded-full bg-current"></span>
                    جميع المستندات
                </a>
                <a href="{{ route('document-archives.create') }}" class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition {{ request()->routeIs('document-archives.create') ? 'bg-blue-600/20 text-blue-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <span class="h-1.5 w-1.5 rounded-full bg-current"></span>
                    رفع مستند جديد
                </a>
            </div>
        ...
        <!-- الإعدادات -->
        <div x-data="{ open: {{ in_array(true, [request()->routeIs('settings.*'), request()->routeIs('currencies.*'), request()->routeIs('fiscal-years.*'), request()->routeIs('import.*')]) ? 'true' : 'false' }} }">
            <button @click="open = !open" class="flex w-full items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition text-gray-300 hover:bg-gray-800 hover:text-white">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-collapse class="mr-8 mt-1 space-y-1">
                ...
                <a href="{{ route('import.index') }}" class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition {{ request()->routeIs('import.*') ? 'bg-blue-600/20 text-blue-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <span class="h-1.5 w-1.5 rounded-full bg-current"></span>
