...
<head>
    ...
    <style>
        ...
        * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'DejaVu Sans', 'Segoe UI', Arial, sans-serif; direction: rtl; text-align: right; font-size: 13px; color: #1f2937; background: white; padding: 20px; max-width: 900px; margin: 0 auto; }
        ...
        .company-name { font-size: 20px; font-weight: bold; color: #2563eb; text-align: center; }
        .company-info { font-size: 11px; color: #6b7280; line-height: 1.6; text-align: center; }
        .document-info h2 { color: #2563eb; font-size: 18px; margin: 0 0 5px 0; text-align: center; }
        .document-info p { font-size: 12px; margin: 2px 0; color: #374151; text-align: center; }
        table { width: 100%; border-collapse: collapse; margin: 10px 0; }
        th { background: #2563eb; color: white; padding: 5px; text-align: center; font-size: 11px; }
        td { padding: 5px; border-bottom: 1px solid #e5e7eb; font-size: 11px; text-align: center; }
        ...
        .footer { margin-top: 20px; border-top: 1px solid #d1d5db; padding-top: 10px; font-size: 11px; color: #9ca3af; text-align: center; }
