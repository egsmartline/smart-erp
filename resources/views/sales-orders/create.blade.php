<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-gray-800">أمر بيع جديد</h2>
    ...
    <form action="{{ route('sales-orders.store') }}" method="POST" x-data="orderForm()" x-init="init()">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="required_date" value="{{ old('required_date') }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                        </div>
                        <div>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="terms" rows="3" class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500" placeholder="شروط البيع...">{{ old('terms') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('sales-orders.index') }}" class="rounded-lg bg-gray-200 px-6 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-300 transition">إلغاء</a>
                </div>
            </div>
        </div>
    </form>
