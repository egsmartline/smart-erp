    ...
    <form action="{{ route('quotations.store') }}" method="POST" id="quotationForm">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-gray-700">تاريخ العرض <span class="text-red-500">*</span></label>
                    <input type="date" name="date" value="{{ old('date', date('Y-m-d')) }}" required
                        class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                </div>
                <div>
                    <label class="mb-1 block text-sm font-medium text-gray-700">صالح حتى <span class="text-red-500">*</span></label>
            ...
            <div id="items-app">
                <div class="mb-4 flex items-center justify-between">
                    <h3 class="text-lg font-bold text-gray-800">أصناف العرض</h3>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="rounded-xl border border-gray-200 bg-gray-50 p-4">
                        <h4 class="text-sm font-bold text-gray-700 mb-3">الخصومات</h4>
                        <div>
                    ...
                    <div class="rounded-xl border border-blue-200 bg-blue-50 p-4">
                        <h4 class="text-sm font-bold text-gray-700 mb-3">ملخص العرض</h4>
                        <div class="space-y-2">
...
(function() {
    ...
    function calcTotals() {
        ...
        var grand = subtotal - totalDisc - discAmt + totalTax;
