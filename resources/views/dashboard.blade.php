        ...
        <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-2xl font-bold text-gray-900">{{ $accountsCount }}</div>
                </div>
        ...
        <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-2xl font-bold text-gray-900">{{ $journalEntriesCount }}</div>
                </div>
        ...
        <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-2xl font-bold text-yellow-600">{{ $draftJournalEntriesCount }}</div>
                </div>
        ...
        <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-2xl font-bold text-green-600">{{ $postedJournalEntriesCount }}</div>
                </div>
