<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-gray-800">مرتجع مشتريات جديد</h2>
    ...
    <form action="{{ route('purchase-returns.store') }}" method="POST" x-data="purchaseReturnForm()">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div>
                ...
                <select name="supplier_id" x-model="supplierId" required class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                    ...
                    <tbody>
                        <template x-for="(line, index) in lines" :key="index">
                            <tr class="border-b border-gray-100">
                                ...
                                <td class="px-3 py-2">
                                    <input type="number" :name="'lines['+index+'][unit_cost]'" x-model.number="line.unit_cost" step="0.01" min="0" required class="w-24 rounded-lg border border-gray-300 px-2 py-1.5 text-sm text-left font-mono focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                                </td>
                                <td class="px-3 py-2">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('purchase-returns.index') }}" class="rounded-lg bg-gray-200 px-6 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-300 transition">إلغاء</a>
        </div>
    </form>
    ...
    <script>
        function purchaseReturnForm() {
            return {
                ...
                lineTotal(line) {
                    const sub = (line.quantity || 0) * (line.unit_cost || 0);
