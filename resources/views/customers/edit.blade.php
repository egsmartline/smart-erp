<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-gray-800">تعديل العميل: {{ $customer->name }}</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="classification" id="classification"
                        ...
                        <option value="gold" {{ old('classification', $customer->classification) === 'gold' ? 'selected' : '' }}>ذهبي</option>
                        <option value="silver" {{ old('classification', $customer->classification) === 'silver' ? 'selected' : '' }}>فضي</option>
                        <option value="bronze" {{ old('classification', $customer->classification) === 'bronze' ? 'selected' : '' }}>برونزي</option>
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    ...
                    <textarea name="notes" id="notes" rows="3"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500">{{ old('notes', $customer->notes) }}</textarea>
                </div>
            </div>
