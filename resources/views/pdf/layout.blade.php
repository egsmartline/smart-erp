...
<head>
    ...
    <style>
        ...
        th { background: #2563eb; color: white; padding: 8px; text-align: right; font-size: 12px; }
        td { padding: 8px; border-bottom: 1px solid #eee; font-size: 12px; text-align: right; }
