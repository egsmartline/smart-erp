    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <x-print-button url="{{ route('pdf.purchase-order', $purchaseOrder) }}" label="تحميل PDF" />
                    ...
                    <table class="w-full text-right text-sm">
                        ...
                        <tfoot>
                            ...
                            <tr class="bg-blue-50">
                                ...
                                <td class="px-3 py-3 text-left font-mono text-lg font-bold text-blue-700" colspan="2">{{ number_format($purchaseOrder->total, 2) }} {{ $purchaseOrder->currency->symbol ?? '' }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
