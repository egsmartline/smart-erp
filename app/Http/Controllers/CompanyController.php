...
class CompanyController extends TenantAwareController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $this->seedPermissionsForTenant($tenant->id);
    ...
    private function seedPermissionsForTenant($tenantId)
    {
        $permissions = [
            'accounts' => [
        ...
        foreach ($permissions as $group => $perms) {
            foreach ($perms as $perm) {
                $savedPermissions[$perm['slug']] = UserPermission::firstOrCreate(
                    ['tenant_id' => $tenantId, 'slug' => $perm['slug']],
        ...
        $roles = [
            'super_admin' => [
                ...
                'description' => 'صلاحية كاملة على جميع أجزاء النظام', 'is_system' => true,
                'permissions' => array_keys($savedPermissions),
            ],
            'admin' => [
                'name' => 'مدير', 'name_en' => 'Admin',
                'description' => 'مدير الشركة - صلاحية كاملة', 'is_system' => true,
                'permissions' => array_keys($savedPermissions),
            ],
            'accountant' => [
                'name' => 'محاسب', 'name_en' => 'Accountant',
                'description' => 'إدارة الحسابات والفواتير والقيود', 'is_system' => true,
                'permissions' => [
            ...
            'warehouse_keeper' => [
                'name' => 'أمين مستودع', 'name_en' => 'Warehouse Keeper',
                'description' => 'إدارة المخزون والمستودعات', 'is_system' => true,
                'permissions' => [
            ...
            'sales' => [
                ...
                'description' => 'إدارة المبيعات والعملاء', 'is_system' => true,
                'permissions' => [
            ...
            'purchases' => [
                'name' => 'مشتريات', 'name_en' => 'Purchases',
                'description' => 'إدارة المشتريات والموردين', 'is_system' => true,
                'permissions' => [
